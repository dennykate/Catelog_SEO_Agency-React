...
const OnScrollNavbar = ({ showSidebar, setShowSidebar }) => {
  ...
  return (
    <div
      className={`h-[100px] w-full bg-primary z-[200] border-b-[1px] border-white border-opacity-20 flex items-center 
